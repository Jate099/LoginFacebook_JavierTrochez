package com.example.a1881user.loginfacebook_javiertrochez;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void printKeyHash(){
        try{
            PackageInfo info   = getPackageManager().getPackageInfo("com.example.a1881user.loginfacebook_javiertrochez",PackageManager.GET_SIGNATURES);
